...
from mmdepth.models import BaseSegmentor
from mmdepth.registry import MODELS
from mmdepth.structures import SegDataSample
from mmdepth.utils import SampleList, dataset_aliases, get_classes, get_palette
...
def init_model(config: Union[str, Path, Config],
    ...
    init_default_scope(config.get('default_scope', 'mmdepth'))
