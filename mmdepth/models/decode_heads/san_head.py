...
from mmdepth.models.backbones.vit import TransformerEncoderLayer
from mmdepth.registry import MODELS
from mmdepth.utils import (ConfigType, MatchMasks, SampleList,
    ...
    def predict(self, inputs: Tuple[Tensor], batch_img_metas: List[dict],
        ...
        Args:
            ...
            batch_img_metas (dict): List Image info where each dict may also
                ...
                `mmdepth/datasets/pipelines/formatting.py:PackSegInputs`.
