...
class DIMLDataset(BaseSegDataset):
    """DIML dataset for depth estimation. An example of file structure
    is as followed.
    .. code-block:: none
        ├── data
        │   ├── diml
    ...
    split file format:
    input_image: test/HR/outleft/0155.png
    gt_depth:    test/HR/depthmap/0155.png
    ...
    def load_data_list(self) -> List[dict]:
        ...
        print_log(f'Loaded {len(img_infos)} images from DIML dataset, split:{self.split}.'
