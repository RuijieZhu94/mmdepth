_base_ = [
    '../_base_/models/scaledepth.py', '../../../../configs/_base_/datasets/nyu_kitti.py',
...
model = dict(
    ...
    decode_head=dict(
        ...
        min_depth=1e-3,
        max_depth=None,
        class_embed_path='projects/ScaleDepth/pretrained_weights/nyu_kitti_class_embeddings_convnext_large_d_320.pth'
    ),
